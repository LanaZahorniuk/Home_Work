...
public class Task {
    ...
    public static <T> Set<T> getSet(List<T> list) {
        return new HashSet<>(list);        //return list.stream().collect(Collectors.toSet());
    }
    ...
    public static Map<String, Long> getDouble(List<String> strings) {
        return strings.stream()
    ...
    static Integer sumOfAges(List<Person> personList) {
